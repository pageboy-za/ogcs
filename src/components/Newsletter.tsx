...
export default function Newsletter() {
  ...
  return (
    <div className="my-16">
      <div id="newsletter" className="py-16 rounded-lg bg-olive-700 sm:py-24">
        <div className="flex flex-col items-center px-6 mx-auto max-w-7xl">
          <div className="max-w-6xl text-3xl font-bold tracking-tight text-white sm:text-4xl">
            {subscribed ? (
          ...
          {!subscribed && (
            <form onSubmit={handleSubmit} method="POST" className="w-full max-w-xl mt-8">
